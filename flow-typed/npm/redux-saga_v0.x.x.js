...
declare module 'redux-saga' {
  ...
  declare type MiddlewareRunFn = (<Y, R, N, Fn: SagaList<Y, R, N>>(saga: Fn) => Task) &
...
declare module 'redux-saga/effects' {
   ...
   * APPLY STUFF
   */
  declare type ApplyFn = (<R, C: Context, Fn: Fn0<R>>(c: C, fn: Fn, ...rest: Array<void>) => CallEffect0<C, Fn>) &
    (<T1, R, C: Context, Fn: Fn1<T1, R>>(c: C, fn: Fn, t1: T1, ...rest: Array<void>) => CallEffect1<C, Fn, T1>) &
    (<T1, T2, R, C: Context, Fn: Fn2<T1, T2, R>>(
      c: C,
      fn: Fn,
      t1: T1,
      t2: T2,
      ...rest: Array<void>
    ) => CallEffect2<C, Fn, T1, T2>) &
    (<T1, T2, T3, R, C: Context, Fn: Fn3<T1, T2, T3, R>>(
      c: C,
      fn: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
      ...rest: Array<void>
    ) => CallEffect3<C, Fn, T1, T2, T3>) &
    (<T1, T2, T3, T4, R, C: Context, Fn: Fn4<T1, T2, T3, T4, R>>(
      c: C,
      fn: Fn,
      t1: T1,
      t2: T2,
      ...
      t4: T4,
      ...rest: Array<void>
    ) => CallEffect4<C, Fn, T1, T2, T3, T4>) &
    (<T1, T2, T3, T4, T5, R, C: Context, Fn: Fn5<T1, T2, T3, T4, T5, R>>(
      c: C,
      fn: Fn,
      t1: T1,
      t2: T2,
      ...
      t5: T5,
      ...rest: Array<void>
    ) => CallEffect5<C, Fn, T1, T2, T3, T4, T5>) &
    (<T1, T2, T3, T4, T5, T6, R, C: Context, Fn: Fn6<T1, T2, T3, T4, T5, T6, R>>(
      c: C,
      fn: Fn,
      t1: T1,
      t2: T2,
      ...
      t6: T6,
      ...rest: Array<void>
    ) => CallEffect6<C, Fn, T1, T2, T3, T4, T5, T6>) &
    (<T, R, C: Context, Fn: FnSpread<T, R>>(
      c: C,
      fn: Fn,
      t1: T,
      t2: T,
      ...
      t6: T,
      ...args: Array<T>
    ) => CallEffectSpread<null, Fn, T>);

  /**
   * CALL STUFF
   */
  declare type ContextCallFn = (<R, C: Context, Fn: Fn0<R>>(cfn: [C, Fn], ...rest: Array<void>) => CallEffect0<C, Fn>) &
  ...
  declare type CallFn = ContextCallFn &
    ...
    (<T1, T2, T3, T4, R, Fn: Fn4<T1, T2, T3, T4, R>>(
      ...
      t3: T3,
      t4: T4
    ) => CallEffect4<null, Fn, T1, T2, T3, T4>) &
    (<T1, T2, T3, T4, T5, R, Fn: Fn5<T1, T2, T3, T4, T5, R>>(
      ...
      t4: T4,
      t5: T5
    ) => CallEffect5<null, Fn, T1, T2, T3, T4, T5>) &
    (<T1, T2, T3, T4, T5, T6, R, Fn: Fn6<T1, T2, T3, T4, T5, T6, R>>(
      ...
      t5: T5,
      t6: T6
    ) => CallEffect6<null, Fn, T1, T2, T3, T4, T5, T6>) &
    (<T, R, Fn: FnSpread<T, R>>(fn: Fn, ...args: Array<T>) => CallEffectSpread<null, Fn, T>);

  /**
   * FORK STUFF
   */
  declare type ContextForkFn = (<R, C: Context, Fn: Fn0<R>>(cfn: [C, Fn], ...rest: Array<void>) => ForkEffect0<C, Fn>) &
    ...
    (<T1, T2, T3, T4, T5, R, C: Context, Fn: Fn5<T1, T2, T3, T4, T5, R>>(
      ...
      t5: T5,
      ...rest: Array<void>
    ) => ForkEffect5<C, Fn, T1, T2, T3, T4, T5>) &
    (<T1, T2, T3, T4, T5, T6, R, C: Context, Fn: Fn6<T1, T2, T3, T4, T5, T6, R>>(
      cfn: [C, Fn],
      t1: T1,
      t2: T2,
      ...
      t6: T6,
      ...rest: Array<void>
    ) => ForkEffect6<C, Fn, T1, T2, T3, T4, T5, T6>) &
    (<T, R, C: Context, Fn: FnSpread<T, R>>(
      cfn: [C, Fn],
      t1: T,
      t2: T,
  ...
  declare type ForkFn = ContextForkFn &
    ...
    (<T1, T2, T3, T4, R, Fn: Fn4<T1, T2, T3, T4, R>>(
      ...
      t4: T4,
      ...rest: Array<void>
    ) => ForkEffect4<null, Fn, T1, T2, T3, T4>) &
    (<T1, T2, T3, T4, T5, R, Fn: Fn5<T1, T2, T3, T4, T5, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      ...
      t5: T5,
      ...rest: Array<void>
    ) => ForkEffect5<null, Fn, T1, T2, T3, T4, T5>) &
    (<T1, T2, T3, T4, T5, T6, R, Fn: Fn6<T1, T2, T3, T4, T5, T6, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      ...
      t6: T6,
      ...rest: Array<void>
    ) => ForkEffect6<null, Fn, T1, T2, T3, T4, T5, T6>) &
    (<T, R, Fn: FnSpread<T, R>>(
      fn: Fn,
      t1: T,
      t2: T,
   ...
   * CPS STUFF
   */
  declare type ContextCpsFn = (<R, C: Context, Fn: Fn0<R>>(cfn: [C, Fn], ...rest: Array<void>) => CpsEffect0<C, Fn>) &
    ...
    (<T1, T2, T3, T4, T5, R, C: Context, Fn: Fn5<T1, T2, T3, T4, T5, R>>(
      ...
      t5: T5,
      ...rest: Array<void>
    ) => CpsEffect5<C, Fn, T1, T2, T3, T4, T5>) &
    (<T1, T2, T3, T4, T5, T6, R, C: Context, Fn: Fn6<T1, T2, T3, T4, T5, T6, R>>(
      cfn: [C, Fn],
      t1: T1,
      t2: T2,
      ...
      t6: T6,
      ...rest: Array<void>
    ) => CpsEffect6<C, Fn, T1, T2, T3, T4, T5, T6>) &
    (<T, R, C: Context, Fn: FnSpread<T, R>>(
      cfn: [C, Fn],
      t1: T,
      t2: T,
  ...
  declare type CpsFn = ContextCpsFn &
    ...
    (<T1, T2, T3, T4, R, Fn: Fn4<T1, T2, T3, T4, R>>(
      ...
      t4: T4,
      ...rest: Array<void>
    ) => CpsEffect4<null, Fn, T1, T2, T3, T4>) &
    (<T1, T2, T3, T4, T5, R, Fn: Fn5<T1, T2, T3, T4, T5, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      ...
      t5: T5,
      ...rest: Array<void>
    ) => CpsEffect5<null, Fn, T1, T2, T3, T4, T5>) &
    (<T1, T2, T3, T4, T5, T6, R, Fn: Fn6<T1, T2, T3, T4, T5, T6, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      ...
      t6: T6,
      ...rest: Array<void>
    ) => CpsEffect6<null, Fn, T1, T2, T3, T4, T5, T6>) &
    (<T, R, Fn: FnSpread<T, R>>(
      fn: Fn,
      t1: T,
      t2: T,
   ...
   * SPAWN STUFF
   */
  declare type ContextSpawnFn = (<R, C: Context, Fn: Fn0<R>>(
    cfn: [C, Fn],
    ...rest: Array<void>
  ) => SpawnEffect0<C, Fn>) &
    ...
    (<T1, T2, T3, T4, T5, R, C: Context, Fn: Fn5<T1, T2, T3, T4, T5, R>>(
      ...
      t5: T5,
      ...rest: Array<void>
    ) => SpawnEffect5<C, Fn, T1, T2, T3, T4, T5>) &
    (<T1, T2, T3, T4, T5, T6, R, C: Context, Fn: Fn6<T1, T2, T3, T4, T5, T6, R>>(
      cfn: [C, Fn],
      t1: T1,
      t2: T2,
      ...
      t6: T6,
      ...rest: Array<void>
    ) => SpawnEffect6<C, Fn, T1, T2, T3, T4, T5, T6>) &
    (<T, R, C: Context, Fn: FnSpread<T, R>>(
      cfn: [C, Fn],
      t1: T,
      t2: T,
      ...
      t6: T,
      ...args: Array<T>
    ) => SpawnEffectSpread<null, Fn, T>);

  declare type SpawnFn = ContextSpawnFn &
    ...
    (<T1, T2, T3, T4, R, Fn: Fn4<T1, T2, T3, T4, R>>(
      ...
      t4: T4,
      ...rest: Array<void>
    ) => SpawnEffect4<null, Fn, T1, T2, T3, T4>) &
    (<T1, T2, T3, T4, T5, R, Fn: Fn5<T1, T2, T3, T4, T5, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      ...
      t5: T5,
      ...rest: Array<void>
    ) => SpawnEffect5<null, Fn, T1, T2, T3, T4, T5>) &
    (<T1, T2, T3, T4, T5, T6, R, Fn: Fn6<T1, T2, T3, T4, T5, T6, R>>(
      fn: Fn,
      t1: T1,
      t2: T2,
      ...
      t6: T6,
      ...rest: Array<void>
    ) => SpawnEffect6<null, Fn, T1, T2, T3, T4, T5, T6>) &
    (<T, R, Fn: FnSpread<T, R>>(
      fn: Fn,
      t1: T,
      t2: T,
   ...
   * SELECT STUFF
   */
  declare type SelectFn = (<Fn: SelectFn>(selector: Fn, ...rest: Array<void>) => SelectEffect0<Fn>) &
    ...
    (<T1, T2, T3, Fn: SelectFn3<T1, T2, T3>>(
      selector: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
      ...rest: Array<void>
    ) => SelectEffect3<Fn, T1, T2, T3>) &
    (<T1, T2, T3, T4, Fn: SelectFn4<T1, T2, T3, T4>>(
      selector: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
      t4: T4,
      ...rest: Array<void>
    ) => SelectEffect4<Fn, T1, T2, T3, T4>) &
    (<T1, T2, T3, T4, T5, Fn: SelectFn5<T1, T2, T3, T4, T5>>(
      selector: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
      ...
      t5: T5,
      ...rest: Array<void>
    ) => SelectEffect5<Fn, T1, T2, T3, T4, T5>) &
    (<T1, T2, T3, T4, T5, T6, Fn: SelectFn6<T1, T2, T3, T4, T5, T6>>(
      selector: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
      ...
      t6: T6,
      ...rest: Array<void>
    ) => SelectEffect6<Fn, T1, T2, T3, T4, T5, T6>) &
    (<T, Fn: SelectFnSpread<T>>(
      selector: Fn,
      t1: T,
      t2: T,
      t3: T,
