...
type $npm$styledComponents$ReactComponentClass<Props, DefaultProps = *> = Class<React$Component<Props>>;
...
type $npm$styledComponents$ReactComponentStyledStaticPropsWithComponent<
  ComponentList
> = any => $npm$styledComponents$ReactComponentStyled<any>;

type $npm$styledComponents$ReactComponentStyledStaticProps<Props, ComponentList> = {|
  attrs: any => $npm$styledComponents$ReactComponentStyledTaggedTemplateLiteral<Props, ComponentList>,
...
declare module 'styled-components' {
  ...
  declare type ReactComponentStyledStaticProps<Props> = $npm$styledComponents$ReactComponentStyledStaticProps<
    Props,
