declare module 'immer' {
   ...
   */
  declare export default function produce<S>(currentState: S, recipe: (draftState: S) => void): S;
  ...
  declare export default function produce<S, A>(recipe: (draftState: S, a: A) => void): (currentState: S) => S;
