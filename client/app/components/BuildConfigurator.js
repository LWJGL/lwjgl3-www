...
const panelContentsClassName = store => classnames("col-xs-12", {"col-lg-3": store.mode !== 'zip', "col-lg-5": store.mode === 'zip'});

class BuildConfigurator extends React.PureComponent {
