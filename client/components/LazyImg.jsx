...
let map: WeakMap<HTMLElement, Function> = new WeakMap();
...
export const LazyImg = memo(({ src: lazySrc, srcSet: lazySrcSet, ...rest }: Props) => {
  const [src, setSrc] = useState(SUPPORTS_INTERSECTION_OBSERVER ? null : lazySrc);
  const [srcSet, setSrcSet] = useState(SUPPORTS_INTERSECTION_OBSERVER ? null : lazySrcSet);
