  ...
  >
    <defs>
      ...
      <symbol id="btn-key" viewBox="0 0 24.48 24" preserveAspectRatio="xMinYMin">
        <path d="M2.2432,0H22.166a2.2432,2.2432,0,0,1,2.2432,2.2432V21.8243a2.2412,2.2412,0,0,1-2.2412,2.2412H2.2422A2.2422,2.2422,0,0,1,0,21.8233V2.2432A2.2432,2.2432,0,0,1,2.2432,0Z" fill="url(#a)"/>
        <path d="M19.8486,19.1768l-14.0151.24-4.2388,4.55a2.1873,2.1873,0,0,0,.6485.0987H22.167a2.2428,2.2428,0,0,0,1.6484-.7227Z" fill="url(#b)"/>
        <path d="M21.1948,18.5967l2.6714,4.6865a2.2215,2.2215,0,0,0,.543-1.4609V2.2412a2.2426,2.2426,0,0,0-1.147-1.956L21.1948,1.4629Z" fill="url(#c)"/>
        <path d="M24.4092,21.8223v-.1895l-3.9785-4.1367-1.3374,2.2432,1.8632,4.3262h1.21A2.2431,2.2431,0,0,0,24.4092,21.8223Z" fill="url(#d)"/>
        <path d="M4.8384,1.5274.3848.9873A2.23,2.23,0,0,0,0,2.2412V21.8223a2.2281,2.2281,0,0,0,.727,1.6494l4.6973-4.2949Z" fill="url(#e)"/>
        <path d="M.0972,22.4766a2.2425,2.2425,0,0,0,2.146,1.5889h.39l4.0913-5.5166L5.1123,18.03Z" fill="url(#f)"/>
        <path d="M22.167,0H2.2432a2.2811,2.2811,0,0,0-.3384.0235l3.91,1.8535H18.93L22.9941.1563A2.2963,2.2963,0,0,0,22.167,0Z" fill="#e6e5e6"/>
        <path d="M22.167,0H19.94L18.603.8291l1.8848,1.7373,3.9062-.5859A2.2438,2.2438,0,0,0,22.167,0Z" fill="url(#g)"/>
        <path d="M.2539,1.2061l4.1836.4912L5.8144.9346,3.9907,0H2.2432A2.2408,2.2408,0,0,0,.2539,1.2061Z" fill="url(#h)"/>
        <path d="M6.45.3926H18.9526a2.4141,2.4141,0,0,1,2.4141,2.4141v15.18a2.415,2.415,0,0,1-2.415,2.415H6.45a2.416,2.416,0,0,1-2.416-2.416V2.8086A2.416,2.416,0,0,1,6.45.3926Z" fill="url(#i)"/>
        <path d="M6.4487.48H18.955a2.3262,2.3262,0,0,1,2.3262,2.3262V17.984a2.3295,2.3295,0,0,1-2.3295,2.3295H6.4472a2.3281,2.3281,0,0,1-2.3281-2.3281V2.81A2.33,2.33,0,0,1,6.4487.48Z" fill="url(#j)"/>
        <path d="M6.4511.5655h12.501a2.2427,2.2427,0,0,1,2.2427,2.2427v15.18A2.2427,2.2427,0,0,1,18.9521,20.23H6.4491A2.2431,2.2431,0,0,1,4.206,17.9874V2.8106A2.2451,2.2451,0,0,1,6.4511.5655Z" fill="url(#k)"/>
      </symbol>
