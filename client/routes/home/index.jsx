        ...
        <section className="container py-5 text-center features">
          ...
          <div className="row">
            ...
            <div className="col-md py-3">
              ...
              <p>
                ...
                our
                {' '}
                <a href="https://github.com/LWJGL/lwjgl3">GitHub repository</a>
                {' '}
                to monitor progress, report issues
          ...
          <div className="row">
            <div className="col pt-3">
              <div className="mb-3">
                <IconMoreApi style={{ fontSize: '6rem' }} color="yellow" />
              </div>
              ...
              <p>
                ...
                or
                {' '}
                <a href="https://github.com/LWJGL/lwjgl3-wiki/wiki/4.5.-The-Generator">contribute it</a>
                {' '}
                yourself!
              </p>
        ...
        <div className="row">
          <div className="col-md-10 offset-md-1">
            ...
            <p>
              ...
              and
              {' '}
              <a href="http://www.puppygames.net/revenge-of-the-titans/">Revenge of the Titans</a>
              {' '}
              by Puppygames.
