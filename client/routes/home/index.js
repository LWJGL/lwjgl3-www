  ...
  render() {
    return (
      <main>
        ...
        <section ref={(el) => {this.container = el}} className="video-container" style={{backgroundImage:env.desktop?null:'url(/img/manfps-720.jpg)'}}>
          {
            do {
              if ( env.desktop ) {
          ...
          <div className="intro">
            ...
            <p className="introText">
              <a href="#learn-more" onClick={learnMoreSmooth}>
                LEARN MORE<br /><FaAngleDown size={"1.5rem"} />
              </a>
            </p>
          </div>
        </section>
          ...
          <section className="container py-4 text-center features">
            ...
            <div className="row">
              <div className="col pt-3">
                <div className="mb-3"><FaQuestionCircle color="yellow" /></div>
