...
interface ConnectedProps {
  ...
  artifacts: { [key: string]: BindingDefinition };
...
function getSelectedPlatforms(build: BuildConfig): NATIVES | null {
  ...
  return result as NATIVES;
}

export class BuildScript extends React.Component<Props> {
  preRef: React.RefObject<HTMLPreElement> = React.createRef();
...
const getVersion = (version: string, build: BUILD_TYPES) => (build === BUILD_RELEASE ? version : `${version}-SNAPSHOT`);
...
function generateDependencies(
  selected: Array<string>,
  artifacts: { [id: string]: BindingDefinition },
  platform: Platforms,
  osgi: boolean,
...
function generateMaven(props: ConnectedProps) {
  ...
  const version = getVersion(props.version, build as BUILD_TYPES);
