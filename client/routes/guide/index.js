      ...
      <main>
        ...
        <section className="container">
          ...
          <p>
            ...
            {' '}
            to configure and download an LWJGL release.
            You will also need a
            {' '}
            <a href="http://www.oracle.com/technetwork/java/javase/downloads/index.html">Java SE Development Kit</a>
            {' '}
            (JDK), LWJGL requires version 8 or higher.
            Then proceed by setting up a project in your favorite IDE and configuring it as described in the
            {' '}
        ...
        <section className="container pt-4">
          <p>
            ...
            &nbsp;and
            {' '}
            <a href="https://github.com/LWJGL/lwjgl3-wiki/wiki/2.5.-Troubleshooting">Troubleshooting</a>
            {' '}
            pages are especially useful.
            For more code examples, see the
            {' '}
            <a href="https://github.com/LWJGL/lwjgl3/tree/master/modules/core/src/test">LWJGL tests suite</a>
            {' '}
            and
          ...
          <ul>
            <li><em>ant</em> – Builds everything and runs the tests</li>

            <li><em>ant compile-templates</em> – Compiles the binding generator templates</li>
            <li><em>ant compile</em> – Compiles the Java code (including generated)</li>
            <li><em>ant compile-native</em> – Compiles and links the native library</li>
            <li><em>ant tests</em> – Runs the test suite</li>
            <li><em>ant demo -Dclass=&lt;demo class&gt;</em> – Runs one of the LWJGL demos in the test module</li>

            <li><em>ant clean</em> – Deletes all files and folders generated by the build script.</li>
            <li><em>and -f update_dependencies.xml</em> – Forces all dependencies to be downloaded again.</li>
          </ul>

          <p>
            Note that the target native architecture is determined by <em>os.arch</em> of the JVM that runs Ant.
            For cross-compiling, use the LWJGL_BUILD_ARCH environment variable to override it (set it to
            {' '}
            <em>x86</em>
            {' '}
            or
          ...
          <p>
            Binary dependencies are downloaded from the stable download branch. Use the LWJGL_BUILD_TYPE environment variable to override this:
          </p>
          <ul>
            <li>
              <em>nightly</em>
              {' '}
              – the latest successful build, possibly broken. Dependency repositories can be found
              {' '}
              <a href="https://github.com/LWJGL-CI">here</a>
            </li>
            <li><em>stable</em> – the latest build that has been verified to work with LWJGL, the default</li>
            <li><em>release/latest</em> – the latest stable build that has been promoted to an official LWJGL $</li>
            <li><em>release/{'{'}build.version{'}'}</em> – a specific previously released build</li>
          </ul>

          <p>
            If you are using custom binaries, or simply need to work offline, set the LWJGL_BUILD_OFFLINE environment variable to one of
            {' '}
            <em>true/on/yes</em>
            .
          </p>
          ...
          <p>
            The LWJGL build process creates thousands of tiny files. If you wish to redirect output to another directory or storage device, you may set the LWJGL_BUILD_OUTPUT environment variable.
          </p>
        </section>
        ...
        <section className="container pt-4">
          ...
          <p>
            ...
            {' '}
            is an Open Source, multi-platform library for creating windows with OpenGL contexts and receiving input and events. It is easy to integrate into existing applications and does not lay claim to the main loop.
          </p>
          <p>
            GLFW is the preferred windowing system for LWJGL 3 applications. If you're familiar with LWJGL 2, GLFW is a replacement for the Display class and everything in the input package.
          </p>
          <p>
          ...
          <h2>OpenGL</h2>
          <p>
            <a href="https://www.opengl.org/about/">OpenGL</a>
            {' '}
            is the premier environment for developing portable, interactive 2D and 3D graphics applications.
          </p>
          <p>
            OpenGL is a massive API with long history and hundreds of extensions. Learning it from scratch is no easy undertaking, but you can start from its
            {' '}
            <a href="https://www.opengl.org/documentation/">documentation</a>
            . The
          ...
          <p>
            ...
            {' '}
            (for "Open Audio Library") is a software interface to audio hardware. The interface consists of a number of functions that allow a programmer to specify the objects and operations in producing high-quality audio output, specifically multichannel output of 3D arrangements of sound sources around a listener.
          </p>
          <p>
